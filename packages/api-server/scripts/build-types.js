...
try {
  ...
  console.warn('tsc declaration emit had errors (pilot lenient mode - continuing to api-extractor for JS + partial types)');
  // Pilot mode: continue to produce JS and whatever types we have
}
