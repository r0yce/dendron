...
const toMarkdownLink = (assetPath, opts) => {
    const name = opts?.name ? opts.name : path_1.default.parse(assetPath).name;
    return `- [${name}](${assetPath})`;
};
class MarkdownImportPod extends basev3_1.ImportPod {
    static id = ID;
    static description = "import markdown";
    get config() {
...
class MarkdownPublishPod extends basev3_1.PublishPod {
    static id = ID;
    static description = "publish markdown";
    get config() {
...
class MarkdownExportPod extends basev3_1.ExportPod {
    static id = ID;
    static description = "export notes as markdown";
    get config() {
