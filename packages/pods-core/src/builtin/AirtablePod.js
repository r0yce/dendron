...
})(SpecialSrcFieldToKey || (exports.SpecialSrcFieldToKey = SpecialSrcFieldToKey = {}));
class AirtableUtils {
            ...
            try {
                ...
                if (common_all_1.ErrorUtils.isAxiosError(error)) {
                    ...
                    if (error.response?.data &&
                        ...
                        payload = lodash_1.default.merge(payload, responseData);
        ...
        await (0, common_all_1.asyncLoopOneAtATime)(notes, async (note) => {
            ...
            await (0, common_all_1.asyncLoopOneAtATime)(Object.entries(srcFieldMapping), async (entry) => {
                ...
                if (lodash_1.default.isString(fieldMapping)) {
                    const val = lodash_1.default.get(note, `${fieldMapping}`) ??
                        lodash_1.default.get(note.custom, `${fieldMapping}`);
...
class AirtablePublishPod extends basev3_1.PublishPod {
    static id = ID;
    static description = "publish to airtable";
    get config() {
...
class AirtableExportPod extends basev3_1.ExportPod {
    static id = ID;
    static description = "export notes to airtable";
    get config() {
