...
class GithubIssueImportPod extends basev3_1.ImportPod {
    static id = ID;
    static description = "import github issues";
    get config() {
     ...
     */
    addFrontMatterToData = (data, fname, config) => {
...
})(GITHUBMESSAGE || (exports.GITHUBMESSAGE = GITHUBMESSAGE = {}));
class GithubIssuePublishPod extends basev3_1.PublishPod {
    static id = ID;
    static description = "publish github issues";
    get config() {
    ...
    async plant(opts) {
        ...
        assignees =
            assignees ?? lodash_1.default.get(note.custom, `${aliasMapping?.assignees?.alias}`);
