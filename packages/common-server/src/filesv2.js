...
exports.FileUtils = exports.tmp = exports.FileExtensionUtils = exports.vault2Path = exports.WS_FILE_MAX_SEARCH_DEPTH = exports.COMMON_FOLDER_IGNORES = void 0;
...
class FileUtils {
     ...
     */
    static matchFilePrefix = async ({ fpath, prefix, }) => {
