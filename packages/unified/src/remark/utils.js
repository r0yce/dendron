...
exports.RemarkUtils = exports.AnchorUtils = exports.LinkUtils = exports.ALIAS_NAME = exports.LINK_NAME = exports.LINK_CONTENTS = exports.visit = exports.mdastBuilder = exports.selectAll = exports.select = void 0;
...
class LinkUtils {
    ...
    static parseNoteRefRaw(ref) {
        ...
        lodash_1.default.each(groups, (v, k) => {
            ...
            if (k === "name") {
                ...
                fname = /^(?<name>.*?)(\.md)?$/.exec(lodash_1.default.trim(v))?.groups?.name;
            }
            else {
                // @ts-ignore
                clean[k] = v;
    ...
    static parseNoteRef(ref) {
        ...
        if (lodash_1.default.isUndefined(noteRef.from?.fname) &&
...
class RemarkUtils {
     ...
     * @returns boolean
     */
    static hasIdenticalChildren = (a, b) => {
