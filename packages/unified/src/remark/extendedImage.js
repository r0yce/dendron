...
exports.extendedImage = exports.matchExtendedImage = exports.EXTENDED_IMAGE_REGEX_LOOSE = exports.EXTENDED_IMAGE_REGEX = void 0;
...
const matchExtendedImage = (text, matchLoose = true) => {
    ...
    if (match && match.groups?.url && match.groups)
        return match[1];
    return undefined;
};
