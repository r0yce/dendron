...
const plugin = function (_opts) {
    ...
    let hierarchyDisplayTitle = config?.publishing.hierarchyDisplayTitle || "Children";
    ...
    function transformer(tree) {
        ...
        function addChildren() {
            ...
            if (lodash_1.default.isBoolean(note.custom?.hierarchyDisplay) &&
            ...
            if (noteCacheForRenderDict) {
                children = HierarchyUtils_1.HierarchyUtils.getChildren({
                    ...
                    .filter((note) => lodash_1.default.isUndefined(note.custom?.nav_exclude) ||
