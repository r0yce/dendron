...
var PublishPodCLICommand = /** @class */ (function (_super) {
    __extends(PublishPodCLICommand, _super);
    function PublishPodCLICommand() {
        return _super.call(this, {
            name: "publishPod",
            desc: "publish a note",
        }) || this;
    }
    PublishPodCLICommand.prototype.buildArgs = function (args) {
        _super.prototype.buildArgs.call(this, args);
        (0, utils_1.setupEngineArgs)(args);
        (0, pod_1.setupPodArgs)(args);
    };
    PublishPodCLICommand.prototype.enrichArgs = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.addArgsToPayload({ podId: args.podId });
                return [2 /*return*/, (0, pod_1.enrichPodArgs)({
    ...
    PublishPodCLICommand.prototype.execute = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var PodClass, config, wsRoot, engine, server, vaults, pod, resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
