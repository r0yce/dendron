 ...
 */
exports.inject = tsyringe_1.inject; // v2 centralized absorption (TS5+ decorator metadata + tsyringe). Permanent single @ts site. See Suppression Registry.
/**
 ...
 */
async function registerWebDependencies(_context /* vscode.ExtensionContext */) {
