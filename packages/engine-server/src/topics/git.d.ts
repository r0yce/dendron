...
export declare class Git {
    ...
    _execute(cmd: string): Promise<execa.ExecaReturnValue<string> & execa.ExecaReturnValue<Buffer>>;
    ...
    fetch(): Promise<execa.ExecaReturnValue<string> & execa.ExecaReturnValue<Buffer>>;
    push(setUpstream?: {
        remote: string;
        branch: string;
    }): Promise<void>;
    /** Creates a dangling stash commit without changing the index or working tree. */
    stashCreate(): Promise<string & Buffer>;
