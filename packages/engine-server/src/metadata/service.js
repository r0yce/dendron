...
})(ShowcaseEntry || (exports.ShowcaseEntry = ShowcaseEntry = {}));
/**
...
})(PriorTools || (exports.PriorTools = PriorTools = {}));
...
})(InactvieUserMsgStatusEnum || (exports.InactvieUserMsgStatusEnum = InactvieUserMsgStatusEnum = {}));
...
})(InitialSurveyStatusEnum || (exports.InitialSurveyStatusEnum = InitialSurveyStatusEnum = {}));
...
})(LapsedUserSurveyStatusEnum || (exports.LapsedUserSurveyStatusEnum = LapsedUserSurveyStatusEnum = {}));
...
})(WorkspaceActivationContext || (exports.WorkspaceActivationContext = WorkspaceActivationContext = {}));
let _singleton;
class MetadataService {
    ...
    getActivationContext() {
        return (this.getMeta().workspaceActivationContext ??
    ...
    setInitialInstall(time) {
        time ||= common_all_1.Time.now().toSeconds();
