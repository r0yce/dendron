...
exports.SEED_REGISTRY = exports.SeedCommands = void 0;
var SeedCommands;
(function (SeedCommands) {
    SeedCommands["ADD"] = "add";
    SeedCommands["INIT"] = "init";
    SeedCommands["INFO"] = "info";
    SeedCommands["REMOVE"] = "remove";
})(SeedCommands || (exports.SeedCommands = SeedCommands = {}));
exports.SEED_REGISTRY = {
    "dendron.dendron-site": {
        id: "dendron.dendron-site",
        name: "dendron-site",
        publisher: "dendron",
        description: "The Dendron Wiki. This contains the Dendron user guide, from getting started to advanced features. This also has information for Dendron developers.",
        ...
        assets: {
            publisherLogo: "https://org-dendron-public-assets.s3.amazonaws.com/images/tutorial-logo_small.png",
        },
    },
    "dendron.handbook": {
        id: "dendron.handbook",
        name: "handbook",
        publisher: "dendron",
        description: "The Dendron Company Handbook. Outlines Company Values and Principles.",
        license: "Creative Commons Attribution 4.0 International",
        root: "handbook",
        repository: {
            type: "git",
