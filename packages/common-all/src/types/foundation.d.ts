 ...
 */
export type NotePropsWithOptionalCustom = Omit<NoteProps, "custom"> & Partial<{
    custom: any;
}>;
...
export type DNoteAnchor = DNoteBlockAnchor | DNoteHeaderAnchor | DNoteLineAnchor;
/**
 ...
 */
export type DNoteAnchorBasic = DNoteBlockAnchor | Omit<DNoteHeaderAnchor, "depth"> | DNoteLineAnchor;
