...
exports.FuseEngine = exports.getCleanThresholdValue = exports.FuseExtendedSearchConstants = void 0;
...
class FuseEngine {
     ...
     */
    static SPECIAL_QUERY_CHARACTERS = [
        "*",
        " ",
        "|",
        "^",
