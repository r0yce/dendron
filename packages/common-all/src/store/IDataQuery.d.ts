...
import { DendronError, NoteChangeEntry, NotePropsByIdDict, NotePropsMeta, SchemaModuleDict, SchemaModuleProps } from "..";
...
export interface IQueryStore {
    queryNotes(qs: string, opts: INoteQueryOpts): ResultAsync<NotePropsMeta[], DendronError>;
    querySchemas(qs: string, opts?: INoteQueryOpts): ResultAsync<{
        id: string;
    }[], DendronError>;
