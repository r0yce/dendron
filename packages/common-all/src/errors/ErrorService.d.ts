...
export interface IErrorService {
     ...
     */
    createTypedError<TCode = StatusCodes | undefined>(props: Omit<DendronErrorProps<TCode>, "name"> & {
        code?: TCode;
    }): DendronError<TCode>;
    /**
...
export declare class DefaultErrorService implements IErrorService {
    create404Error(opts: {
        url: string;
    }): DendronError;
    createUnexpectedEventError(opts: {
 ...
 */
export declare const ERROR_SERVICE_TOKEN: "ErrorService";
