 ...
 */
export declare const schemaForType: <T>() => <S extends ZodType<T, any, any>>(arg: S) => S;
/**
 ...
 * @returns Result<T>
 */
export declare const parse: <T extends z.ZodTypeAny>(schema: T, raw: unknown, msg?: string) => Result<z.infer<T>, DendronError>;
